    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("🧐 JOIN OUR CHANNEL 😎", url="https://telegram.me/tharamaanamovies")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("🧐 JOIN OUR CHANNEL 😎", url="https://telegram.me/tendkotta")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("🧐 JOIN OUR TEAM 😎", url="https://telegram.me/tharamaanateambot")]
            ])
